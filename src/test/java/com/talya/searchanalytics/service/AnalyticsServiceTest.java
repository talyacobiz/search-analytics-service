...
public class AnalyticsServiceTest {
    ...
    void testSummaryAndFull() {
        ...
        when(searchRepo.findAllByShopIdAndTimestampMsBetween(anyString(), anyLong(), anyLong())).thenReturn(List.of(new SearchEvent()));
        when(clickRepo.findAllByShopIdAndTimestampMsBetween(anyString(), anyLong(), anyLong())).thenReturn(List.of(new ProductClickEvent()));
        when(cartRepo.findAllByShopIdAndTimestampMsBetween(anyString(), anyLong(), anyLong())).thenReturn(List.of(new com.talya.searchanalytics.model.AddToCartEvent()));
        when(purchaseRepo.findAllByShopIdAndTimestampMsBetween(anyString(), anyLong(), anyLong())).thenReturn(List.of(new com.talya.searchanalytics.model.PurchaseEvent()));
        when(buyNowRepo.findAllByShopIdAndTimestampMsBetween(anyString(), anyLong(), anyLong())).thenReturn(List.of(new com.talya.searchanalytics.model.BuyNowClickEvent()));
